                ...
                <div class="col-lg-6">
                    <checkout-form
                        ...
                        <div class="left-content-area">
                            ...
                            <form action="checkout.html" class="checkout-form">
                                <div class="row">
                                    <div class="col-lg-6">
                    ...
                    <cart :initial-content="{{ app(\App\Shop\Carts\Repositories\CartRepository::class)->getWholeCart() }}" :updated-content="cartContent" v-cloak inline-template>
                        <div class="right-content-area">
                            ...
                            <ul class="order-list">
                                ...
                                <li>
                                    <div class="single-order-list title-bold">
                                        Total <span class="right normal">@{{ content.total }} €</span>
                                    </div>
                                </li>
                            </ul>
                            @foreach($payments as $payment)
                                <div class="checkbox-element account">
                                    <div class="checkbox-wrapper">
                                        <label class="checkbox-inner">{{ $payment->title }}
                                            <input name="{{ $payment->id }}" value="{{ $payment->id }}" type="checkbox">
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                </div>
