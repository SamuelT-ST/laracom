<div class="form-group row align-items-center">
    <label for="groups" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.address.columns.groups') }}</label>
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('alias'), 'has-success': this.fields.alias && this.fields.alias.valid }">
    <label for="alias" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.address.columns.alias') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.alias" v-validate="'required'" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('alias'), 'form-control-success': this.fields.alias && this.fields.alias.valid}" id="alias" name="alias" placeholder="{{ trans('admin.address.columns.alias') }}">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('address_2'), 'has-success': this.fields.address_1 && this.fields.address_1.valid }">
    ...
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.address_1" v-validate="'required'" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('address_1'), 'form-control-success': this.fields.address_1 && this.fields.address_1.valid}" id="address_1" name="address_1" placeholder="{{ trans('admin.address.columns.address_1') }}">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('address_2'), 'has-success': this.fields.address_2 && this.fields.address_2.valid }">
    ...
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.city" v-validate="'required'" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('city'), 'form-control-success': this.fields.city && this.fields.city.valid}" id="city" name="city" placeholder="{{ trans('admin.address.columns.city') }}">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('phone'), 'has-success': this.fields.phone && this.fields.phone.valid }">
    ...
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.phone" v-validate="'required'" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('phone'), 'form-control-success': this.fields.phone && this.fields.phone.valid}" id="phone" name="phone" placeholder="{{ trans('admin.address.columns.phone') }}">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('zip'), 'has-success': this.fields.zip && this.fields.zip.valid }">
    ...
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.zip" v-validate="'required'" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('zip'), 'form-control-success': this.fields.zip && this.fields.zip.valid}" id="zip" name="zip" placeholder="{{ trans('admin.address.columns.zip') }}">
...
<div class="form-check row" :class="{'has-danger': errors.has('status'), 'has-success': this.fields.status && this.fields.status.valid }">
    <div class="ml-md-auto" :class="isFormLocalized ? 'col-md-8' : 'col-md-10'">
        ...
        <label class="form-check-label" for="status">
            {{ trans('admin.address.columns.status') }}
        </label>
