                ...
                <div class="card">
                    ...
                    <div class="card-body" v-cloak>
                        ...
                        <table class="table table-hover table-listing">
                            <thead>
                            <tr>
                                <th is='sortable' :column="'name'">{{ trans('admin.customers.columns.name') }}</th>
                                <th is='sortable' :column="'email'">{{ trans('admin.customers.columns.email') }}</th>
                                <th>{{ trans('admin.customers.columns.groups') }}</th>
                        ...
                        <div class="no-items-found" v-if="!collection.length > 0">
                            ...
                            <a class="btn btn-primary btn-spinner" href="{{ url('admin/customers/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp; {{ trans('admin.customers.actions.create') }}</a>
                        </div>
                    </div>
                </div>
            </div>
