...
class FillPermissionsForPaymentMethod extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPaymentMethod constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.payment-method.show',
            'admin.payment-method.edit',
            'admin.payment-method.delete',
        ]);
