...
class FillPermissionsForProductGroup extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForProductGroup constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.product-group',
            'admin.product-group.index',
            'admin.product-group.create',
            'admin.product-group.show',
            'admin.product-group.edit',
