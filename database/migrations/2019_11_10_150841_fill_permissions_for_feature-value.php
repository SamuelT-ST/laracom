...
class FillPermissionsForFeatureValue extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForFeatureValue constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.feature-value',
            'admin.feature-value.index',
            'admin.feature-value.create',
            'admin.feature-value.show',
            'admin.feature-value.edit',
            'admin.feature-value.delete',
        ]);
